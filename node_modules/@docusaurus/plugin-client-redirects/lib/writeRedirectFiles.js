...
const createRedirectPageContent_1 = (0, tslib_1.__importDefault)(require("./createRedirectPageContent"));
...
function toRedirectFilesMetadata(redirects, pluginContext, trailingSlash) {
    ...
    const createPageContentMemoized = (0, lodash_1.memoize)((toUrl) => {
        return (0, createRedirectPageContent_1.default)({ toUrl });
    });
...
async function writeRedirectFile(file) {
    try {
        ...
        throw new Error(`Redirect file creation error for "${file.fileAbsolutePath}" path: ${err}.`);
    }
}
